  ...
  private creationRelationships(assetId: string): AssetCreationRelationshipDto[] {
    const rows = this.db
      ...
      SELECT 'GENERATION_RUN' AS relationship_kind, run.id AS relationship_id,
        ...
        series.id AS series_id, series.title, series.title_zh, series.title_en,
